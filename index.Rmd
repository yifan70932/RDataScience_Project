...
##Data Retriving and Chloropleth Visualization

###Islam Population, 2010 - 2050
...
###Christianity Population, 2010 - 2050
```{r, warning = FALSE}
...
###Buddahism Population, 2010 - 2050
```{r, warning = FALSE}
...
###Religious Unaffiliated Population, 2010 - 2050
```{r, warning = FALSE}
...
#Pie chart, for each country, map the population of different religions in a pie chart
...
mapPies(pie_2010_plot, 
        ...
        zColours = c('green','purple','red','blue'),
        oceanCol = 'light blue',
        landCol = 'wheat',
        symbolSize = 2.5)
```
